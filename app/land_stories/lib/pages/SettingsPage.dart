      ...
      child: Center(
        child: Column(
          ...
          children: <Widget>[
            ...
            PlatformButton( //Helpful button for testing the app
              child: Text("Insert testing data"),
              onPressed: () async {
                List stories = [
                  Story(heading: "Saw a tree", context: "Today I saw a beautiful tree at the park."),
                  Story(heading: "Go for a ride", context: "I need some exercise today."),
                  Story(heading: "Study", context: "Study pythagoruses theorum for the test coming up.", )
                ];
            ...
            PlatformButton(child: Text("Delete all"), onPressed: () async {
